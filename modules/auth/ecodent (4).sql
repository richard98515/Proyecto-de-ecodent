...
CREATE TABLE `mensajes_pendientes` (
  ...
  `tipo` enum('confirmacion','recordatorio_24h','recordatorio_1h','cancelacion','reprogramacion') NOT NULL,
...
(1, 5, 5, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-14 14:33:04', NULL, '2026-03-14 14:33:04'),
(2, 4, 8, '', 'email', 'Tu cita ha sido cancelada por el odontólogo. Motivo: emergencia. \r\n                    Por favor, ingresa al sistema para elegir una nueva fecha entre las opciones disponibles.', NULL, NULL, 0, '2026-03-16 15:15:05', NULL, '2026-03-16 15:15:05'),
(3, 4, 9, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 02:45:19', NULL, '2026-03-17 02:45:19'),
(4, 3, 3, '', 'email', 'Tu cita ha sido cancelada por el odontólogo. Motivo: capacitacion. \r\n                    Por favor, ingresa al sistema para elegir una nueva fecha entre las opciones disponibles.', NULL, NULL, 0, '2026-03-17 03:11:49', NULL, '2026-03-17 03:11:49'),
(5, 4, 17, '', 'email', 'Tu cita ha sido cancelada por el odontólogo. Motivo: emergencia. \r\n                    Por favor, ingresa al sistema para elegir una nueva fecha entre las opciones disponibles.', NULL, NULL, 0, '2026-03-17 03:25:39', NULL, '2026-03-17 03:25:39'),
(6, 3, 21, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 03:50:21', NULL, '2026-03-17 03:50:21'),
(7, 3, 22, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 03:50:25', NULL, '2026-03-17 03:50:25'),
(8, 3, 20, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 03:56:56', NULL, '2026-03-17 03:56:56'),
(9, 3, 15, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 04:00:43', NULL, '2026-03-17 04:00:43'),
(10, 3, 2, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 04:02:13', NULL, '2026-03-17 04:02:13'),
(11, 4, 18, '', 'email', 'Tu cita ha sido cancelada por el odontólogo. Motivo: emergencia. \r\n                    Por favor, ingresa al sistema para elegir una nueva fecha entre las opciones disponibles.', NULL, NULL, 0, '2026-03-17 04:52:14', NULL, '2026-03-17 04:52:14'),
(12, 4, 24, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 05:06:08', NULL, '2026-03-17 05:06:08'),
(13, 4, 23, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 05:06:10', NULL, '2026-03-17 05:06:10'),
(14, 4, 26, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 05:06:11', NULL, '2026-03-17 05:06:11'),
(15, 4, 11, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 05:06:13', NULL, '2026-03-17 05:06:13'),
(16, 4, 10, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 05:06:14', NULL, '2026-03-17 05:06:14'),
(17, 4, 25, 'cancelacion', 'email', 'Tu cita ha sido cancelada exitosamente. Puedes agendar un nuevo horario cuando lo desees.', NULL, NULL, 0, '2026-03-17 05:06:16', NULL, '2026-03-17 05:06:16'),
...
(3, 5, NULL, NULL, 0, 4, NULL, 'normal', 1, 3, NULL),
(4, 6, '2021-11-22', 'z/villa Dolores C/sebarullo N/1814', 0, 0, NULL, 'restringida', 1, 3, NULL);
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('paciente','odontologo') NOT NULL,
...
--
ALTER TABLE `slots_bloqueados`
  MODIFY `id_bloqueo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
ALTER TABLE `slots_bloqueados`
  ...
  ADD CONSTRAINT `slots_bloqueados_ibfk_1` FOREIGN KEY (`id_odontologo`) REFERENCES `odontologos` (`id_odontologo`) ON DELETE CASCADE;
