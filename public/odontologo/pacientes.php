...
<div class="row mb-3">
    <div class="col-md-8">
        <h1><i class="bi bi-people-fill text-primary"></i> Mis Pacientes</h1>
        <p class="lead">Gestiona tus pacientes, visualiza su información y estado.</p>
    </div>
    <div class="col-md-4 text-end">
        <a href="paciente_nuevo.php" class="btn btn-primary">
            <i class="bi bi-person-plus-fill"></i> Nuevo Paciente
        </a>
        <a href="odontologos.php" class="btn btn-outline-secondary">
            <i class="bi bi-person-badge"></i> Ver Odontólogos
        </a>
    </div>
</div>
                ...
                <tbody>
                    <?php if ($pacientes->num_rows > 0): ?>
                        <?php while ($paciente = $pacientes->fetch_assoc()): 
                            // Contar citas del paciente con este odontólogo
